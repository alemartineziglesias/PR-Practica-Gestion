...
public class ConsultaJugador implements ActionListener, WindowListener
{
	...
	ConsultaJugador(int tipoUsuario)
	{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			String nombreArchivo="Jugadores.xlsx";
			String rutaArchivo= "C:\\Users\\studi\\Downloads\\" + nombreArchivo;
			String hoja = "Hoja1";
			XSSFWorkbook libro = new XSSFWorkbook();
			XSSFSheet hoja1 = libro.createSheet(hoja);
			// Cabeceras de la hoja de excel
			String [] header = new String[]{"ID", "Nombre", "Apellidos", "Edad", "Posición", "Nacionalidad"};
			// Contenido de la hoja de excel
			String elementos = datos.rellenarExcelJugadores();
			...
			try (FileOutputStream fileOuS = new FileOutputStream(file))
			{
				...
				Utilidades.guardarLogExportacionJugador(tipoUsuario);
				libro.close();
			}
