...
public class ConsultaEquipo implements ActionListener, WindowListener
{
	...
	ConsultaEquipo(int tipoUsuario)
	{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			String nombreArchivo="Equipos.xlsx";
			String rutaArchivo= "C:\\Users\\studi\\Downloads\\" + nombreArchivo;
			String hoja = "Hoja1";
			XSSFWorkbook libro = new XSSFWorkbook();
			XSSFSheet hoja1 = libro.createSheet(hoja);
			// Cabeceras de la hoja de excel
			String [] header = new String[]{"ID", "Equipos", "Ciudades"};
			// Contenido de la hoja de excel
			String elementos = datos.rellenarExcelEquipos();
			...
			try (FileOutputStream fileOuS = new FileOutputStream(file))
			{
				...
				Utilidades.guardarLogExportacionEquipo(tipoUsuario);
				libro.close();
			}
