...
public class ConsultaFichaje implements ActionListener, WindowListener
{
	Frame ventana = new Frame("Listado fichajes");
	...
	ConsultaFichaje(int tipoUsuario)
	{
		ventana.setLayout(new FlowLayout());
		datos.conectar();
		listado.append(datos.dameFichajes());
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			String nombreArchivo="Fichajes.xlsx";
			String rutaArchivo= "C:\\Users\\studi\\Downloads\\" + nombreArchivo;
			String hoja = "Hoja1";
			XSSFWorkbook libro = new XSSFWorkbook();
			XSSFSheet hoja1 = libro.createSheet(hoja);
			// Cabeceras de la hoja de excel
			String [] header = new String[]{"ID", "Fecha", "Precio", "Equipos", "Jugadores"};
			// Contenido de la hoja de excel
			String elementos = datos.rellenarExcelFichajes();
			...
			try (FileOutputStream fileOuS = new FileOutputStream(file))
			{
				...
				Utilidades.guardarLogExportaciónFichaje(tipoUsuario);
				libro.close();
			}
